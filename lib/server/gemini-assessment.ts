...
import { Finding, GeminiAssessmentOutput, SymbolContext } from "../../contracts";
...
export interface AssessmentInput { commentId: string; comment: string; language: string | null; kind: string; symbol: SymbolContext | null; context: string | null; findings: Finding[]; }
