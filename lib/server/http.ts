...
import { WorkflowConfigurationError } from "./workflow-config";
...
export function handleError(error: unknown) {
  ...
  if (error instanceof WorkflowConfigurationError) return jsonError("internal_error", "Internal server error", 503);
